        ...
        for (int z = 0; z < 9; z++) {
            for (int x = 0; x < 8; x++) {
                for (int i = x + 1; i < 9; i++) {
                    ...
                    at_most_one_row_clause->add_literal(literals[x][y][z], true);
                    at_most_one_row_clause->add_literal(literals[i][y][z], true);
        ...
        for (int z = 0; z < 9; z++) {
            for (int y = 0; y < 8; y++) {
                for (int i = y + 1; i < 9; i++) {
                    ...
                    at_most_one_column_clause->add_literal(literals[x][y][z], true);
                    at_most_one_column_clause->add_literal(literals[x][i][z], true);
                ...
                for (int x = 0; x < 3; x++) {
                    for (int y = 0; y < 3; y++) {
                        for (int k = y+1; k < 3; k++) {
                            ...
                            at_most_one_sub_grid_1->add_literal(literals[3*i+x][3*j+y][z], true);
                            at_most_one_sub_grid_1->add_literal(literals[3*i+x][3*j+k][z], true);
                    ...
                    for (int y = 0; y < 3; y++) {
                        for (int k = x+1; k < 3; k++) {
                            for (int l = 0; l < 3; l++) {
                                ...
                                at_most_one_sub_grid_2->add_literal(literals[3*i+x][3*j+y][z], true);
                                at_most_one_sub_grid_2->add_literal(literals[3*i+k][3*j+l][z], true);
